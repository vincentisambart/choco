...
extern "C" {
    ...
    fn choco_Foundation_NSCopyingProtocol_copy(self_: ptr::RawPtr) -> Option<ptr::RawPtr>;
...
where
    Item: ptr::Type,
{
    type Item = ptr::OwnedPtr<Item>;

    fn next(&mut self) -> Option<ptr::OwnedPtr<Item>> {
...
//         value: NSUInteger,
//     ) -> Option<ptr::RawPtr>;
//     fn choco_Foundation_NSNumberInterface_instance_boolValue(self_: ptr::RawPtr) -> BOOL;
...
//     fn choco_Foundation_NSErrorInterface_instance_code(self_: ptr::RawPtr) -> NSInteger;
...
//     raw_ptr: Option<ptr::RawPtr>,
//     raw_unowned_error: Option<ptr::RawPtr>,
